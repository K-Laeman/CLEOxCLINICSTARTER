    ...
    <div className='max-w-7xl mx-auto px-5'>
        <div className="flex flex-col items-center h-full">
            ...
            <div className='flex flex-col lg:flex-row items-center lg:items-end justify-start lg:justify-center w-full mb-[50px] lg:mb-[102px]'>
                <label className='font-[400] text-[14px] lg:text-[24px] text-[#000000] text-center leading-[24px] lg:leading-[38px]'>สอบถามข้อมูลเพิ่มเติมได้ที่ </label>
                <a href="line://ti/p/@clinicstarter" target="_blank" className='flex justify-center items-center w-[36px] h-[36px] rounded-full bg-[#000000] my-[18px] lg:my-0 lg:mx-[12px]'>
                    <BsLine className='text-[#90e8d5] text-[18px] text-center' />
                </a>
                <label className='font-[400] text-[14px] lg:text-[24px] text-[#000000] text-center leading-[24px] lg:leading-[38px]'> @clinicstarter</label>
            </div>
